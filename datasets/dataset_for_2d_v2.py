    ...
    def __init__(self, data_roots, with_path = False, transform = None):
        ...
        for cube_name in cube_names:
            for data_root in data_roots:
                # print(cube_name, data_root)
                assert os.path.exists(os.path.join(data_root, cube_name)), os.path.join(data_root, cube_name)
        ...
        print(len(self.img_name_list), len(self.cube_name_list))
